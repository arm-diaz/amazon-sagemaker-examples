"""
SageMaker Training Script for Fuel Delivery Optimization
==========================================================
Uses AutoGluon-TimeSeries for training consumption forecast models.
...
def parse_args():
    ...
    # Column names (fuel delivery defaults)
    parser.add_argument("--target-column", type=str, default="daily_consumption")
    parser.add_argument("--item-id-column", type=str, default="tank_id")
    parser.add_argument("--timestamp-column", type=str, default="reading_date")
